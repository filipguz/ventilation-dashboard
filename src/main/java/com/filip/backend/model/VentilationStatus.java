...
public class VentilationStatus {
    ...
    public int getSupplyFanPercent() {

        return supplyFanPercent;

    }


    public int getExtractFanPercent() {

        return extractFanPercent;
    ...
    public List<Integer> getRawRegisters() {
