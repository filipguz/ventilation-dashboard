...
The current goal is read-only monitoring.
The system reads live values from the ventilation unit and displays them in a custom React dashboard.
...
Previously I had mostly worked with server-rendered applications using Thymeleaf.
This project is also a way for me to get hands-on experience with a more modern frontend stack.
